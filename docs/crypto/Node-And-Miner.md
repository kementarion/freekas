...
区块链，是一个全球的公共账本，记录全部交易历史记录。交易，是账本上的一条条记录，如 "张三转给李四 5 个 KAS 币"。
...
攻击者只控制 51% 结点，是**很难（几乎不可能）篡改历史**的，最可能的攻击是**隔离并欺骗一部分网络参与者**。
