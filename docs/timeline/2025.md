...
- Shai 大胡子 ([https://x.com/DesheShai](https://x.com/DesheShai)) 是一名数学博士，参与了部分 Kaspa 的论文证明工作，曾是 Kaspa 团队早期成员之一。

- 与 KEF 之间因进度问题的批评而最终决裂：

    * KEF (Kaspa Eco Foundation) 是 Kaspa 区块链的生态基金会，旨在加速 Kaspa 生态系统的开发、采用和可持续性，包括智能合约和生态建设。

    * KEF 赞助了多名 Kaspa 核心开发人员的工作。

    * KEF 赞助 Shai 写一本 Kaspa 科普的书，但因为进度问题对 Shai 提出批评，双方最终闹翻。这本书也一直没有完成……
...
- 因开发核心团队声明 Shai 早已不参加核心团队工作，他的发言不再代表核心团队的意见，而引起 Shai 的不满，最终（可能由于各种误会）决裂。
...
- Shai 在与核心团队闹矛盾之前，就经常作为以色列人发表对中东地区战争冲突的观点而引起很多争议。

- Shai 后来大力支持 Igra Labs， 依然经常发表充满争议的观点，如：
...
## 2025-11-26 区块浏览器 kaspa.stream 上线

- [https://kaspa.stream/](https://kaspa.stream/)

    - 区块浏览器(Block Explorer) 可以查询区块、地址、交易的细节，以及当前整个项目的所有情况。

    - 作者：[https://x.com/supertypo_kas](https://x.com/supertypo_kas)

    - 参考信息：[https://x.com/supertypo_kas/status/1993372952247910803](https://x.com/supertypo_kas/status/1993372952247910803)

::: tip

另一个常用的 Kaspa 区块浏览器是：[https://kas.fyi/](https://kas.fyi/)
