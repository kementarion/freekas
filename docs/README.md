...
- Kaspa 采用**基于 DAG（有向无环图）** 的 **PoW 协议**，把区块链从**一维变成了多维**，具有**每秒 10 个区块**的出块速度。
  ...
  * 下一步， **DagKnight** 协议上线，出块速度将再次提升（目标是 100 BPS）。
...
- 2025 年 9 月，Kasplex 智能合约平台正式上线。
  ...
  * 查看当前的智能合约项目：[https://kas.fyi/l2-networks](https://kas.fyi/l2-networks)
...
- 未来，矿工可依靠交易手续费维持网络长久、安全地运行，实现 PoW 的长期可持续性。详见：[未来矿工收益问题讨论](./topic/Fee.md)
